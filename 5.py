5. Demonstrate Linear Regression operation using python programming. import pandas as pd
import numpy as np
...
x = dataset[['TV']]
y = dataset['Sales']
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size = 0.3, random_state = 100) slr= LinearRegression()
